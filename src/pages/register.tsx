  ...
  const userTypes = [
    {
      id: 'listener',
      label: 'Oyente',
      description: 'Quiero escuchar música',
      icon: Headphones
    },
    {
      id: 'artist',
      label: 'Artista',
      description: 'Quiero subir mi música',
      icon: Music
    },
    {
      id: 'advertiser',
      label: 'Anunciante',
      description: 'Quiero crear anuncios',
      icon: Mic
    }
  ];
              ...
              >
                {userTypes.map((type) => (
                  <div key={type.id} className="flex items-center space-x-2">
                    ...
                    <Label 
                      htmlFor={type.id} 
                      className="flex items-center gap-2 cursor-pointer flex-1 p-2 rounded hover:bg-accent/50"
                    >
